...
def generate_url():
    start_urls = ['https://www.techpowerup.com/cpu-specs/?mfgr=AMD&released=2010&sort=name']
    for it in range(2009, 1999, -1):
        start_urls.append('https://www.techpowerup.com/cpu-specs/?mfgr=AMD&released={}&sort=name'.format(it))
...
def get_data(start_urls):
    ...
    amd_df.to_csv('amd_cpu_specs1.csv',index = False)
